...
function compare_solvers(solvers,probs,n;title:: String = " ", kwargs...)
...
function compare_solvers_CUTEst(solvers,probs,n_min,n_max;title:: String = " ", kwargs...)
...
function compare_solvers_Ampl(solvers, ampl_prob_dir, probs,n_min,n_max;title:: String = " ", kwargs...)
